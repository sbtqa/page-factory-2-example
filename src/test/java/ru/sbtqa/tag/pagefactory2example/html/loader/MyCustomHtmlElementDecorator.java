package ru.sbtqa.tag.pagefactory2example.html.loader;
...
/**
 * Custom decorator for example
 */
public class MyCustomHtmlElementDecorator extends CustomHtmlElementDecorator {

    public MyCustomHtmlElementDecorator(CustomElementLocatorFactory factory) {
        super(factory);
    }
